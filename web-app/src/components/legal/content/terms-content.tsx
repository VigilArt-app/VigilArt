...
const ENGLISH_TERMS = (
  <>
    ...
    <ul>
      <li>
        generate a draft copyright infringement report or DMCA takedown notice,
        where applicable;
      </li>
      <li>generate the document as a PDF or email; and</li>
      <li>
        direct you to the relevant reporting form provided by a third-party
        platform.
      </li>
    </ul>
    <p>
    ...
    <p>
      ...
      not control their content, availability, or security.
    </p>
    <p>You access external websites at your own discretion.</p>
    ...
    <ul>
      ...
      <li>use VigilArt for unlawful purposes.</li>
    </ul>
    ...
    <h2>9. Changes</h2>
    <p>We may update these Terms as VigilArt evolves.</p>
...
const FRENCH_TERMS = (
  <>
    ...
    <ul>
      <li>
        générer un projet de signalement pour violation du droit d’auteur ou une
        notification de retrait DMCA, lorsque cela s’applique ;
      </li>
    ...
    <p>
      Vous êtes responsable de la vérification des informations avant l’envoi de
      tout signalement et devez vous assurer que votre demande est exacte et
      légitime.
    </p>
    <p>
    ...
    <p>
      Les résultats de recherche peuvent mener vers des sites tiers contenant du
    ...
    <p>
      Nous pouvons restreindre ou supprimer votre accès au service en cas de
